...
all_connections = ((port_a, port_b) for port_a in ports for port_b in ports if port_a != port_b)
all_connections_filtered = ((port_a, port_b) for port_a in ports for port_b in ports if port_a > port_b)
