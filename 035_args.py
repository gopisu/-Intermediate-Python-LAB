...
print('We need', calculate_paint(1, *rooms_1), 'l of paint for', len(rooms_1), 'rooms of the sizes', rooms_1)
print('We need', calculate_paint(1, *rooms_2), 'l of paint for', len(rooms_2), 'rooms of the sizes', rooms_2)
